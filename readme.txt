...
2. From Woocommerce settings menu open 'Payment gateways' tab, and select 'Visma Pay'
3. Fill in private key and API key.  These two can be found from Visma Pay merchant portal.
4. Save settings and make test order and payment to confirm everything works.
